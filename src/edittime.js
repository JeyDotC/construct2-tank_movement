function GetBehaviorSettings()
{
	return {
		...
		"id":			"TankMovement",
		"version":		"0.9",
		"description":	"Moves an object as in the first versions of Resident Evil.",
		"author":		"JeyDotC",
		"help url":		"https://github.com/JeyDotC/construct2-tank_movement",
		"category":		"Movements",
		"flags":		0
	};
};
...
AddComboParamOption("Forward");
AddComboParamOption("Backward");
AddComboParamOption("TurnLeft");
AddComboParamOption("TurnRight");
...
AddNumberParam("Rotation Speed", "The rotation speed in degrees per second.");
AddAction(11, 0, "Set Rotation Speed", "", "Set {my} rotation speed to <b>{0}</b>", "Set the rotation speed.", "SetRotationSpeed");

AddNumberParam("Forward Angle", "The new forward angle in degrees.");
AddAction(12, 0, "Set Forward Angle", "", "Set {my} forward angle to <b>{0}</b>", "Set the angle at which the object will move if forward is pressed.", "SetForwardAngle");
...
AddExpression(6, ef_return_number, "Get rotation speed", "", "RotationSpeed", "The rotation speed in degrees per second.");
AddExpression(6, ef_return_number, "Get forward angle", "", "ForwardAngle", "The angle at which the object will move if forward is pressed.");
...
var property_list = [
	...
	new cr.Property(ept_float, "Turn Speed", 360, "The speed at which this object will turn in degrees per second."),
	new cr.Property(ept_combo, "Set angle", "Yes", "Rotate the instance or not.", "No|Yes"),
